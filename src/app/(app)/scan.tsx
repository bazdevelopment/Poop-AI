...
function ScanningOverlay({ capturedImage, isScanning }) {
  return (
    <View className="absolute inset-0 -top-10 items-center justify-center">
      ...
      <View className="relative">
        ...
        {!isScanning && (
          <>
            <View className="absolute -top-4 -left-4 size-20 rounded-tl-[30px] border-t-[6px] border-l-[6px] border-white" />
            <View className="absolute -top-4 -right-4 size-20 rounded-tr-[30px] border-t-[6px] border-r-[6px] border-white" />
            <View className="absolute -bottom-4 -left-4 size-20 rounded-bl-[30px] border-b-[6px] border-l-[6px] border-white" />
            <View className="absolute -right-4 -bottom-4 size-20 rounded-br-[30px] border-r-[6px] border-b-[6px] border-white" />
          </>
        )}
