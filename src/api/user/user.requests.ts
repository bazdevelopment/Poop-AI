...
export async function sendOtpCodeViaEmail({
  email,
  language,
}: {
  email: string;
...
export async function decrementNumberOfScans({
  language,
}: {
  language: string;
}) {
...
/** Get user info  */
export async function getUserInfo({ language }: { language: string }) {
  try {
...
export async function createPermanentAccount({
  email,
  password,
