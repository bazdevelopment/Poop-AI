export type ICreateLogRequestData = {
  language: string;
  timezone: string;
...
export type IUpdateLogRequestData = {
  language: string;
  logId: string;
  fieldsToUpdate: {
...
export type IUpdateLogResponseData = {
  success: boolean;
  message: string;
};

export type ICreateLogResponseData = {
  xpEarned: number;
  gemsEarned: number;
  newStreak: number;
};
 ...
 */
export type IRequestCalendarActivity = {
